...
Objetivo: Esse é o script que controla o estado do jogo (GameState). O código trata os eventos do jogo, possui as referências para elementos de UI. É uma classe "Singleton".
